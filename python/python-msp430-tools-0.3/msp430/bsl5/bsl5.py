...
BSL_SERIAL_NB           = 0x1c    # Set BSL Serial NB
...
class BSL5(object):
    ...
    def BSL_SERIAL_NB(self,data):
        """Set a serial Number"""
        answer = self.bsl(BSL_SERIAL_NB, 'A' + data, expect=0)
        self.check_answer(answer)

    def set_serial_nb(self, data):
        """Set a serial Number"""
        return self.BSL_SERIAL_NB(data)
